...
var ProductLowSchema = new Schema({
...
ProductLowSchema.set('toJSON',{ virtuals: true })

ProductLowSchema.virtual('brand', {
    ref: 'Brand',
    localField: 'id_brand',
    foreignField: '_id',
    justOne: true
...
ProductLowSchema.virtual('category', {
    ref: 'Category',
...
export default mongoose.model('ProductLow', ProductLowSchema)
